...
public class VodMoreView extends RelativeLayout implements RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void init(Context context) {
        ...
        mSwitchSR = (Switch) findViewById(R.id.superplayer_switch_sr);
        mSwitchVR = (Switch) findViewById(R.id.superplayer_switch_vr);
        ...
        mSwitchSR.setOnCheckedChangeListener(this);
        mSwitchVR.setOnCheckedChangeListener(this);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
        ...
        } else if (compoundButton.getId() == R.id.superplayer_switch_sr) {
            if (mCallback != null) {
                mCallback.onSRChange(isChecked);
            }
        } else if (compoundButton.getId() == R.id.superplayer_switch_vr) {
            if (mCallback != null) {
                mCallback.onVRChange(isChecked);
            }
        }
    }
    ...
    public interface Callback {
         ...
         * @param isOpen
         */
        void onSRChange(boolean isOpen);
         ...
         * @param isOpen
         */
        void onVRChange(boolean isOpen);
    }
